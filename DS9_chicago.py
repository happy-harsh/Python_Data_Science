...
data = pd.concat([pd.read_csv('./archive/Chicago_Crimes_2001_to_2004.csv', error_bad_lines=False),
                  pd.read_csv('./archive/Chicago_Crimes_2005_to_2007.csv', error_bad_lines=False),
                  pd.read_csv('./archive/Chicago_Crimes_2008_to_2011.csv', error_bad_lines=False),
                  pd.read_csv('./archive/Chicago_Crimes_2012_to_2017.csv', error_bad_lines=False),
                  ],ignore_index=True)
data.head()
